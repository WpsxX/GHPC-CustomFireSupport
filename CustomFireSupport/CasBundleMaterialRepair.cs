    ...
    internal static class CasBundleMaterialRepair
    {
        ...
        internal static void RepairBundleMaterials()
        {
            ...
            try
            {
                ...
                int restored = 0, recovered = 0, approximated = 0, unknown = 0, hidden = 0;
                ...
                // A heat-distortion map cannot be displayed by a plain colour/alpha shader.
                // Keep smoke/fire visible; suppress only these helper renderers until native binding succeeds.
